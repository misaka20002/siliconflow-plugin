          ...
          componentProps: {
            ...
            schemas: [
              ...
              },
              {
                ...
                label: "API地址",
                component: "Input",
                bottomHelpMessage: "仅当接口为 OpenAI格式绘画API接口 时填写，以 /images/generations 格式接入，此接口对比#s接口可以使用 2160*3840 或 5张 的语法强制控制宽高；通常是以 /v1 结尾",
                componentProps: {
          ...
          componentProps: {
            ...
            schemas: [
              ...
              },
              {
                ...
                label: '活跃开始时间',
                bottomHelpMessage: '（本群）格式：HH:mm，例如：08:00',
                component: 'Input',
                componentProps: {
                  placeholder: '08:00',
                }
              },
              {
                field: 'activeEndTime',
                label: '活跃结束时间',
                bottomHelpMessage: '（本群）格式：HH:mm，例如：23:00（支持跨夜）',
                component: 'Input',
                componentProps: {
                  placeholder: '23:00',
                }
