...
- 在`绘画模型`中填入你在 [AICG专区](https://www.modelscope.cn/aigc/models) 中找到的喜欢的模型，点进去，来到例如 [/Qwen/Qwen-Image-Edit-2511](https://www.modelscope.cn/models/Qwen/Qwen-Image-Edit-2511) 的网站，然后复制粘贴 `模型名`
- 在 `文件名` 中填写你喜欢的文件名
